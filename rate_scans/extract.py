...
def select(f_class, l1_type='def'):
    ...
    # save the index of the clases we DON'T want
    index = []
    ...
    for periodicity in [2, 5]:
        ...
        if periodicity == 2:
            for i in range(len(Y)-7):
                if  (Y[i] >= 100) and (Y[i+1] == 0)   and (Y[i+2] >= 100) and (Y[i+3] == 0) and (Y[i+4] >= 100) and (Y[i+5] == 0) and (Y[i+6] >= 100) and (Y[i+7] == 0):
            ...
            for i in range(len(Y) - 11):
                if  (Y[i] >= 100) and (Y[i+1] == 0) and (Y[i+2] == 0) and (Y[i+3] == 0) and (Y[i+4] == 0)    and (Y[i+5] >= 100) and (Y[i+6] == 0) and (Y[i+7] == 0) and (Y[i+8] == 0) and (Y[i+9] == 0) and (Y[i+10] >= 100) and (Y[i+11] == 0):
